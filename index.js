...
app.get('/employees/:id', (req, res) => {
    mysqlConnection.query('SELECT * FROM Employee WHERE job_id=?', [req.params.id], (err, rows, fields) => {
        if (!err)
            //console.log(rows);
            res.send(rows);
        else
...
app.delete('/employees/:id', (req, res) => {
    mysqlConnection.query('DELETE FROM Employee WHERE job_id=?', [req.params.id], (err, rows, fields) => {
        if (!err)
            //console.log(rows);
...
app.put('/employees/update', (req, res) => {
    ...
    mysqlConnection.query('UPDATE employee  SET ?  ', [req.body], (err, rows, fields) => {
        if (!err)
            //console.log(rows);
